...
from config.trading import (
    ...
    TAKE_PROFIT_LEVELS,
    MIN_SHARE_VALUE_SOL,
    DUST_TOKEN_AMOUNT_UI,
    TOKEN_AMOUNT_FLOOR_DECIMALS,
...
from config.monitor import (
    ...
    FRESH_POSITION_RPC_GRACE_SEC,
    FRESH_POSITION_RETRY_DELAY_SEC,
    NEW_HUNTER_ADD_WINDOW_SEC,
    TRADER_BIRDEYE_PRICE_TIMEOUT,
    TRADER_RPC_ERROR_SLEEP_SEC,
    TRADER_VERIFY_RETRY_SLEEP_SEC,
    TRADER_VERIFY_POLL_INTERVAL_SEC,
    TRADER_RETRY_COOLDOWN_SEC,
